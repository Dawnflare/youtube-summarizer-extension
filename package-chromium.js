...
const sourceDir = path.join(__dirname, 'Chromium');
const outPath = path.join(__dirname, 'chromium-extension.zip');
...
// Append files from the Chromium directory, placing them at the root of the zip
